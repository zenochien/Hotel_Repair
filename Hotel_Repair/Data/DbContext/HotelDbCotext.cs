...
{
    public class HotelDbCotext : DbContext
    {
        public HotelDbCotext(DbContextOptions<HotelDbCotext> options) : base(options)
        {
        }

        public DbSet<BookingStatus> bookings { get; set; }
